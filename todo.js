...
$("#formToDo").on('submit',function(e){
    e.preventDefault();
    var userInput3= $("#new-todo-des").val()
    var userdes=$("#new-todo-des").val()
    var userInput2= $("#new-todo-dead").val()
    var userdes=$("#new-todo-dead").val()
    var userInput= $("#new-todo-item").val()
    var userdes=$("#new-todo-item").val()
  ...
  $("ul").on("mouseleave" ,"li", function (){
      $(".details, .delete, .done");
      $(".deatils, .delete, .done").addClass("new");
  });*/
...
function showTasks() {
    ...
    if (taskObj.length != 0) {
        ...
        tasksElm.innerHTML = '<p>The task List is empty!!Add a Task</p>';
    }
}
...
search.addEventListener("input", function () {
  ...
  $("ul").on("mouseenter" ,"li", function (){
      $(".details, .delete, .done").show();
      $(".details, .delete, .done").addClass("new");
  });
